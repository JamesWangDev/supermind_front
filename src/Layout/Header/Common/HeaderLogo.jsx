  ...
  return (
    <>
      ...
      <Link href='/' className='web-logo nav-logo'>
        {isImage ? <Image src={logo} className="img-fluid" alt='Header' height={64} width={162} /> : <Image src={logo ? logo : logoImage} className="img-fluid" alt='Header' height={28} width={162} />}
      </Link>
    </>
  );
};
